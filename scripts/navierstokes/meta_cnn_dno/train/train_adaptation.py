...
script = "regression_adaptation.py"
...
if __name__ == "__main__":
    ...
    tasks = [
        (
            ...
            True,
            1,
            "./checkpoint/darcy/meta_cnn_dno/train/Meta_CNN_DNO_init_train_lr-0.0100_wb-8_ib-8_rotm-fixed_run-1_err-0.0550_epoch-88.pt",
            2,
            0,
        ),
    ]
