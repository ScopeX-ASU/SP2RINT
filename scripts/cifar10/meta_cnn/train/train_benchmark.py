...
if __name__ == "__main__":
    ...
    tasks = [
        ...
        (0.002, 0, "default", True, True, 2, "phase", 4, 0.3, 0.850, 0, 0, 32, 4, [17], "Ours", "none", 3, 3, "phase_mag", 0, False, "last_time", True, False, False, False, True, "both", "constant", 15, 15, 3, 3, 50, 15, 3, 1, 1, "green_fn", 50, 50, None, "TMMatching", False, "fourier", 9, 20, 0, "diag", "level_set", "avg", "field", "wo_lens", 5e-3, True, 10, 2, "epoch", 72, 54, 36, 3, 0.2, 0.4, False, 1, "per_epoch", 30, 128, 0.5),
