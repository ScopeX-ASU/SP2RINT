...
if __name__ == "__main__":
    ...
    tasks = [
        ...
        (0.001, 0, "default", True, True, 2, "phase", 4, 0.3, 0.850, 2, 0, 32, 16, [17], "Ours_from_scratch_double_budget", "none", 3, 3, "phase_mag", 0, True, "last_time", True, False, False, False, True, "both", "constant", 15, 15, 3, 3, 50, 15, 3, 1, 1, "green_fn", 50, 50, None, None, "TMMatching", False, "fourier", 9, 20, 0, "diag", "level_set", "avg", "field", "wo_lens", 5e-3, True, 20, 2, "epoch", 72, 54, 36, 3, 0.2, 0.4, False, 1, "per_epoch", 30, 128, 0, False, "width"),
        # (0.002, 0, "default", True, True, 2, "phase", 4, 0.3, 0.850, 2, 0, 32, 4, [17], "Ours_from_scratch_double_budget_rerun_1", "none", 3, 3, "phase_mag", 0, True, "last_time", True, False, False, False, True, "both", "constant", 15, 15, 3, 3, 50, 15, 3, 1, 1, "green_fn", 50, 50, None, None, "TMMatching", False, "fourier", 9, 20, 0, "diag", "level_set", "avg", "field", "wo_lens", 3e-3, True, 20, 2, "epoch", 72, 54, 36, 3, 0.2, 0.4, False, 1, "per_epoch", 20, 128, 0, False, "width"),
        # (0.001, 0, "default", True, True, 2, "phase", 4, 0.3, 0.850, 3, 0, 32, 4, [17], "Ours_transfer_from_FMNIST_small_lr_1", "none", 3, 3, "phase_mag", 0, True, "last_time", True, False, False, False, True, "both", "constant", 15, 15, 3, 3, 50, 15, 3, 1, 1, "green_fn", 50, 50, "./checkpoint/fmnist/meta_cnn/train/Meta_CNNETE_init_train_lr-0.0020_c-Exp6_out_ds_3_TMMat_tall_tgt_acc-89.93_epoch-44.pt", "./checkpoint/fmnist/meta_cnn/train/Meta_CNNETE_init_train_lr-0.0020_c-Exp6_out_ds_3_TMMat_tall_tgt_test_acc-89.93_epoch-44.pt", "TMMatching", False, "fourier", 9, 20, 0, "diag", "level_set", "avg", "field", "wo_lens", 2e-3, True, 20, 2, "epoch", 72, 54, 36, 3, 0.2, 0.4, False, 1, "per_epoch", 20, 128, 0, False, "width"),
        ...
        # (0.0005, 0, "default", True, True, 2, "phase", 4, 0.3, 0.850, 1, 1, 32, 16, [1], "baseline_LPA", "none", 3, 3, "phase", 0, False, "last_time", False, True, True, False, True, "both", "constant", 15, 15, 15, 15, 50, 15, 15, 1, 1, "green_fn", 50, 50, None, None, "TMMatching", False, "fourier", 13, 20, 0, "diag", "level_set", "avg", "field", "wo_lens", 5e-3, True, 20, 2, "epoch", 72, 54, 36, 3, 0.2, 0.4, False, 1, "per_epoch", 30, 128, 0, False, "width"),
        # (0.001, 0, "default", True, True, 2, "phase", 4, 0.3, 0.850, 0, 1, 32, 16, [17], "baseline_smoothen_transfer_matrix", "none", 3, 3, "phase_mag", 0, False, "last_time", True, False, False, False, True, "both", "constant", 15, 15, 15, 15, 50, 15, 15, 1, 1, "green_fn", 50, 50, None, None, "TMMatching", False, "fourier", 13, 20, 0.5, "diag", "level_set", "avg", "field", "wo_lens", 5e-3, True, 20, 2, "epoch", 72, 54, 36, 3, 0.2, 0.4, False, 1, "per_epoch", 30, 128, 0, False, "width"),
        # (0.001, 0, "conv", True, True, 2, "phase", 4, 0.3, 0.850, 2, 1, 32, 16, [17], "baseline_conv_LPA", "none", 3, 3, "phase_mag", 0, False, "last_time", False, True, True, False, True, "both", "constant", 15, 15, 15, 15, 50, 15, 15, 1, 1, "green_fn", 50, 50, None, None, "TMMatching", False, "fourier", 13, 20, 0, "diag", "level_set", "avg", "field", "wo_lens", 5e-3, True, 20, 2, "epoch", 72, 54, 36, 3, 0.2, 0.4, False, 1, "per_epoch", 30, 128, 0, False, "width"),
