...
def task_launcher(args):
    mixup, device_type, data_dir, test_data_dir, alg, fourier_feature, incident_field, pos_enc, dim, num_layers, mode1, mode2, id, description, gpu_id, epochs, alm, lr, criterion, criterion_weight, H_loss, maxwell_loss, grad_loss, grad_sim_loss, s_param_loss, alm_lambda, alm_mu, mu_growth, constraint_tol, checkpt_fwd, checkpt_adj, bs, switch_epoch, n_test, n_train = args
    env = os.environ.copy()
...
if __name__ == '__main__':
    ...
    tasks = [
        ...
        # [0.0, "mdm", "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", False, 24, 4, 50, 50, 40, "Exp3_FNO_No_light_field", 0, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 1],
        # [0.0, "mdm", "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", True, 24, 4, 50, 50, 41, "Exp3_FNO_light_field", 1, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 1],
        # [0.0, "mdm", "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", False, 24, 4, 50, 50, 42, "Idea_FNO_two_stage_No_light_field", 2, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 20],
        # [0.0, "mdm", "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", True, 24, 4, 50, 50, 43, "Idea_FNO_two_stage_light_field", 3, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 20],

        # [0.0, "bending", "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", False, "none", 24, 4, 50, 50, 44, "Main_result_FNO_bending", 0, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 60, 400, 2000],
        # [0.0, "bending", "raw_random", "raw_test", "FNO2d", "none", False, "none", 24, 4, 50, 50, 45, "Exp1_FNO_from_random", 1, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 60, 400, 2000],

        # [0.0, "mdm", "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", False, "none", 24, 4, 50, 50, 46, "Main_result_FNO_MDM", 0, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 60, 400, 2000],
        # [0.0, "mdm", "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", True, "none", 24, 4, 50, 50, 47, "Exp3_FNO_Incident_light_field", 1, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 60, 400, 2000],

        # [0.0, 'wdm', "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", False, "none", 24, 4, 50, 50, 48, "Main_result_FNO_WDM", 0, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 60, 400, 2000],
        # [0.0, 'wdm', "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", False, "exp", 24, 4, 50, 50, 49, "Exp4_FNO_Pos_Enc", 1, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 60, 400, 2000],

        # [0.0, 'tdm', "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", False, "none", 24, 4, 50, 50, 50, "Main_result_FNO_TDM", 0, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 60, 400, 2000],
        # [0.0, 'optical_diode', "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", False, "none", 24, 4, 50, 50, 51, "Main_result_FNO_OD", 1, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 60, 400, 2000],
        # [0.0, 'crossing', "raw_opt_traj_ptb", "raw_test", "FNO2d", "none", False, "none", 24, 4, 50, 50, 52, "Main_result_FNO_crossing", 2, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 60, 400, 2000],

        [0.0, "bending", "raw_opt_traj", "raw_test", "FNO2d", "none", False, "none", 24, 4, 50, 50, 53, "FNO_bending_No_ptb", 0, 50, False, 0.002, "nmse", 1, 1, 0, 0, 0, 0, 0.0, 1, 2, 1e-4, "none", "none", 4, 60, 400, 2000],
    ]   
