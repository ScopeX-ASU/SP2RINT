...
def task_launcher(args):
    mixup, device_type, data_dir, test_data_dir, alg, output_sparam, fourier_feature, dim, id, description, gpu_id, epochs, alm, lr, criterion, criterion_weight, H_loss, maxwell_loss, grad_loss, s_param_loss, direct_s_param_loss, alm_lambda, alm_mu, mu_growth, constraint_tol, checkpt_fwd, checkpt_adj, bs, n_test, n_train = args
    env = os.environ.copy()
...
if __name__ == '__main__':
    ...
    tasks = [
        ...
        [0.0, "bending", "raw_opt_traj_ptb", "raw_test", "UNet", True, "none", 32, 2, "Exp1_UNet_single_value_pred", 3, 50, False, 0.002, "nmse", 0, 0, 0, 0, 0, 1, 0, 1, 2, 1e-4, "none", "none", 4, 400, 2000],
    ]   
